...
/**
 * Created by sally.hung on 2015/9/18.
 */
public class ListWidget extends AppWidgetProvider{
    public static final String CLICK_ACTION = "com.rong.widget.CLICK_ACTION";
    public static final String CLICK_EXTRA = "com.rong.widget.CLICK_EXTRA";
    @Override
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        for (int appWidgetId : appWidgetIds) {
            ...
            rv.setPendingIntentTemplate(R.id.list,
